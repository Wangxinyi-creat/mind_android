...
public final class InputTextManager implements TextWatcher {
     ...
     * @param view  跟随 TextView 输入为空来判断显示或隐藏这个 View
     * @param alpha 是否需要设置透明度
     */
    private InputTextManager(View view, View clearView, boolean alpha) {
        if (view == null) {
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (mClearView != null) {
            mClearView.setVisibility(enabled ? View.VISIBLE : View.GONE);
        }
    ...
    public static final class Builder {
        ...
        public Builder setClear(View view) {
            mClearView = view;
            return this;
        }
        ...
        public InputTextManager build() {
            InputTextManager helper = new InputTextManager(mView, mClearView, isAlpha);
